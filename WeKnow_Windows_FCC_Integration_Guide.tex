...
%=====================================================================
% COVER  (We Know Group brand: white cover with the large centred WeKnow
%         logo as the hero and the title "FreedomPay Windows FCC
%         Documentation" below. Azure as accent: symmetric wink-echo tint
%         motifs framing the top, and a centred Azure hero rule.)
%=====================================================================
\begin{titlepage}
\thispagestyle{empty}
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north,align=center,text width=185mm]
       ...
       {{\color{weknowgraphite}\fontsize{26}{31}\selectfont\bfseries FreedomPay Windows FCC Documentation}\\[11pt]
        {\color{weknowazure}\rule{42mm}{2pt}}\\[11pt]
        {\color{weknowsea}\fontsize{16}{20}\selectfont Auth \& Capture Integration Guide}};

  % --- Metadata panel (content structure per WeKnow spec cover), sky card ---
  \node[anchor=north, fill=weknowsky, rounded corners=3mm,
       ...
       {\renewcommand{\arraystretch}{1.5}%
        \begin{tabular}{@{}l@{\hspace{12mm}}l@{}}
          ...
          {\color{weknowsea}\bfseries Date} & {\color{weknowgraphite}July 2026}\\
          {\color{weknowsea}\bfseries Classification} & {\color{weknowgraphite}Confidential}\\
          {\color{weknowsea}\bfseries Prepared by} & {\color{weknowgraphite}We Know Group --- Integrations}\\
          {\color{weknowsea}\bfseries Status} & {\color{weknowgraphite}Issued for FreedomPay certification}\\
        \end{tabular}};

  % --- Confidentiality notice + rule (bottom, centred) ---
  \node[anchor=south,align=center,text width=150mm]
       ...
       {{\color{weknowgreyM}\rule{55mm}{0.4pt}}\\[8pt]
        {\color{weknowgreyN}\footnotesize This document contains confidential and proprietary
         information belonging to We Know Group. It is intended solely for the use of authorised
         recipients and may not be reproduced or distributed without prior written consent.}};
\end{tikzpicture}
\end{titlepage}
...
\subsection{WeKnow certification \& integration support}\label{sec:wkg-support}

The WeKnow \textbf{Integration Support team} handles certification-related
support issues --- questions about this integration, the certification
process, configuration sign-off, and any fault that WeKnow L1 triage
attributes to the WeKnow side of the integration. Reach out to the primary
contact first; if they are unavailable, work down to the secondary and
tertiary contacts before escalating to FreedomPay for issues within the
FreedomPay ecosystem.

\begin{center}
\renewcommand{\arraystretch}{1.3}\small
\begin{tabularx}{\textwidth}{L{20mm} L{34mm} L{30mm} X}
\rowcolor{weknownight}\color{white}\textbf{Contact} &
\color{white}\textbf{Name} & \color{white}\textbf{Phone} &
\color{white}\textbf{Email}\\
Primary & Vedant Kalbag & +44\,XXXXXXXXXX &
\href{mailto:vedant.kalbag@weknowgroup.com}{vedant.kalbag@weknowgroup.com}\\
\rowcolor{weknowgreyL}
Secondary & Jasbir Jandu & +44\,XXXXXXXXXX &
\href{mailto:jjandu@weknowgroup.com}{jjandu@weknowgroup.com}\\
Tertiary & Vignesh Vuchoor & +44\,XXXXXXXXXX &
\href{mailto:vignesh.vuchoor@weknowgroup.com}{vignesh.vuchoor@weknowgroup.com}\\
\end{tabularx}
\end{center}
