...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north] at ([yshift=-64mm]current page.north)
       {\includegraphics[width=58mm]{wkg-logo-stacked}};

  % --- Centred title / Azure hero rule / subtitle ---
  \node[anchor=north,align=center,text width=185mm]
       at ([yshift=-150mm]current page.north)
       {{\color{weknowgraphite}\fontsize{26}{31}\selectfont\bfseries FreedomPay Windows FCC Documentation}\\[12pt]
        {\color{weknowazure}\rule{42mm}{2pt}}\\[12pt]
